  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="bg-teal-950/60 border border-teal-700/50 rounded-xl p-4">
          <div className="flex items-start gap-3">
            <FlaskConical className="h-4 w-4 text-teal-400 mt-0.5 shrink-0" />
            ...
            <Button
              ...
              disabled={loading}
              className="bg-[#0F766E] hover:bg-teal-700 text-white shrink-0 text-xs h-7 px-3"
            >
              Try Demo
            </Button>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="bg-slate-700 border-slate-600 text-white placeholder:text-slate-500 focus:border-teal-600 text-center text-2xl tracking-widest"
                  disabled={loading}
                />
              </div>
              <Button
