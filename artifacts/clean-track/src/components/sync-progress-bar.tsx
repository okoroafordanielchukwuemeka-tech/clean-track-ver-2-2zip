...
export function SyncProgressBar() {
  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-950/40 border-b border-blue-200 dark:border-blue-800 px-4 py-2">
      ...
      <div className="w-full bg-blue-200 dark:bg-blue-800/60 rounded-full h-1.5 overflow-hidden">
        <div
          className={cn(
